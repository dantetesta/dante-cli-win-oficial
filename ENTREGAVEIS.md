...
- `dist/installer/DanteCLI-Setup-1.0.30-x64.exe` — **stub real** (PE32 self-extracting, 79 KB) — comprovação de que a sintaxe NSIS está válida
...
# Pega dist\installer\DanteCLI-Setup-1.0.30-x64.exe e executa
```
